...
## Relationship to OpenChord

This is a separate project from [OpenChord](https://github.com/keyandcableco/openchord),
which replaces chord logic ICs in instruments like the Suzuki Omnichord.
This project replaces only the top-octave generator. The Omni 2 is a
different class of instrument and doesn't need chord logic replacement.
